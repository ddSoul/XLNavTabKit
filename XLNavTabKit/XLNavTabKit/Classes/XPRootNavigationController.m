...
//            backImage = viewController.backIconImage;
            backImage = [UIImage imageNamed:@"nav_back"];
...
//        [viewController.navigationController.navigationBar setBackIndicatorImage:[RSIMAGE(@"nav_back") imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
//        [viewController.navigationController.navigationBar setBackIndicatorTransitionMaskImage:[RSIMAGE(@"nav_back") imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
//        UIBarButtonItem *backItem = [[UIBarButtonItem alloc] initWithTitle:@""
//                                                                     style:UIBarButtonItemStylePlain
//                                                                    target:viewController
//                                                                    action:@selector(xp_popViewController)];
